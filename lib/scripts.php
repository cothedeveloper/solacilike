...
function roots_scripts() {
  ...
  wp_enqueue_style('slick_nav', get_template_directory_uri() . '/assets/css/slicknav.css', false, '9880649384aea9f1ee166331c0a30daa');
  ...
  wp_register_script('slicknav', get_template_directory_uri() . '/assets/js/SlickNav-master/jquery.slicknav.js', array(), null, false);
      wp_register_script('pinit', get_template_directory_uri() . '/assets/js/pin_it.js',array(), null, false);
  wp_register_script('customjs', get_template_directory_uri() . '/assets/js/custom.js', array(), null, false);
