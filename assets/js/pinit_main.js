...
(function (w, d, a) {
  ...
  'rules': [
    ...
    // PIN IT BUTTON -- 20px
	//I change this one for the pin it button.
    'a._pin_it_button_20 {  background-repeat: none; background-size: 80px 80px; height: 80px; margin: 0; padding: 0; vertical-align: baseline; text-decoration: none; width: 80px; background-position: 0 -20px }',
    ...
    'a._pin_it_button_en_20_gray { background-image: url(http://localhost/wordpress/wp-content/themes/solacilike/assets/img/pushPin.png);background-position: 5px; background-repeat:no-repeat;}',
